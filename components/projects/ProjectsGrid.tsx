...
export default function ProjectsGrid() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "A food ordering platform where users browse restaurant menus, customize items with meal upgrades and real-time price calculations...",
      image: "/images/projects/muhaidfoods.png",
      tech: ["React", "MUI", "Tailwind", "Vercel"],
      link: "https://restuarant-website-hazel.vercel.app/",
      video: null,
    },

    {
      ...
      description:
        "A Squad Security Agency buisness website build on Next.js showcasing their Services , Clients , About , Contact us and handle forms connected to mail... ",
    ...
    },
    {
      title: "Hire Hunt ",
      description:
        "A PHP-based recruitment platform enabling HRs to post jobs and applicants to explore and apply seamlessly. Admin username & password is usman",
    ...
    },
    {
      title: "Bookify",
      description:
        "A book brand website highlighting services, portfolio, and interactive forms using PHP and MySQL. Built with PHP, jQuery, HTML, and CSS..",
    ...
    },
    {
      ...
      description:
        "A security services website showcasing company work, services, and contact options for potential clients. Built with HTML, CSS, JavaScript, and jQuery.",
    ...
    },
    {
      ...
      description:
        "Ai-Powered Restaurent suggestion web in which you can create your restaurent and our AI suggest you restaurent base on number of persons and budget.",
    ...
    },
    {
      ...
      description:
        "A full-stack web app for university shuttle services managing students , drivers, and admin operations. Built with React, Flask, Material-UI, and MariaDB.",
    ...
    },
    {
      title: "Spotify Clone",
      description:
        "A responsive Spotify clone project replicating core UI and functionality. Built using HTML, CSS, JavaScript, and media queries.",
  ...
  return (
    <section
      className="w-full py-8 md:py-13  backdrop-blur-lg mt-16 md:mt-19"
      style={{
        backgroundImage:
          " conic-gradient(at top right, #09021aff 0%, #3f1736ff 10%, #100D2F 66%, #020220ff 100%)",
      }}
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
          {projects.map((proj, i) => (
            <Animate key={i} type="fade-up">
              <Card
                className="bg-[#0F172B] backdrop-blur-xl text-white border-white/20 shadow-xl py-0 pb-4 
                ...
                <CardContent className="flex flex-wrap gap-2 ">
                  {proj.tech.map((t, idx) => (
                    <Badge
                      key={idx}
                      variant="secondary"
                      className="bg-white/10 text-white rounded-md hover:bg-white/20"
                    >
                      {t}
                    </Badge>
                  ))}
